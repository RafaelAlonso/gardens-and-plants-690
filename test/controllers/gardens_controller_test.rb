...
class GardensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create garden" do
    assert_difference('Garden.count') do
      post gardens_url, params: { garden: { banner_url: @garden.banner_url, description: @garden.description, name: @garden.name } }
    end
  ...
  test "should update garden" do
    patch garden_url(@garden), params: { garden: { banner_url: @garden.banner_url, description: @garden.description, name: @garden.name } }
